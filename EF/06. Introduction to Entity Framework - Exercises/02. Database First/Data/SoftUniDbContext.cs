namespace P02_DatabaseFirst.Data
{
    ...
    public partial class SoftUniContext : DbContext
    {
        ...
        public virtual DbSet<EmployeeProjects> EmployeesProjects { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                var server = File.ReadAllText(@"C:\Users\spzvt\Documents\SQL-Data\DB-Server-Connection.txt");
                optionsBuilder.UseSqlServer($@"Server={server};Database=SoftUni;Integrated Security=True;");
            }
        }
